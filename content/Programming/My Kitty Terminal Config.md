...
From [[My Kitty Terminal Config| my kitty terminal config]] article post, I thought I would share my kitty configurations. Usually when you download kitty, it gives narrating comments on how to set up each part of kitty. If you would like to see that version of my kitty.conf, follow this link to my [github gist](https://gist.github.com/imcbee/55bd85f3bc7ad971591c64c2b20895d3). 
